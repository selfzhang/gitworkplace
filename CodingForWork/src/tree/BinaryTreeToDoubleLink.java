...
public class BinaryTreeToDoubleLink {
	Tree head = null;
	Tree realHead = null;
	...
	public static void Convert(Tree pRootOfTree, Tree lastNode) {
		if (pRootOfTree == null) {
			return;
		}
		Tree currentNode = pRootOfTree;
		if (currentNode.left != null)
			Convert(currentNode.left, lastNode);
		...
		if (currentNode.right != null)
			Convert(currentNode.right, lastNode);
	}
