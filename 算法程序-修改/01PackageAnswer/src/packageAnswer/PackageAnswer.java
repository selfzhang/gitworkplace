...
public class PackageAnswer {
	...
	public PackageAnswer(){
		
	}
	public PackageAnswer(int[] weight, int[] value, int things_count,
			int packetC) {
		long startTime=System.currentTimeMillis(); 
		getPackageAnswer(weight, value, things_count, packetC);
		long endTime=System.currentTimeMillis(); 
		time = endTime-startTime;
		
	}

	public void getPackageAnswer(int[] weight, int[] value, int things_count,
			int packetC) {
